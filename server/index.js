...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production' 
    ? [
        process.env.FRONTEND_URL || 'https://ecommerce-frontend-hpet3v78n-yash-kumar-jhas-projects.vercel.app',
        'https://ecommerce-frontend-cip351ojw-yash-kumar-jhas-projects.vercel.app',
